...
class UserControllerTest extends BaseControllerTest {
    ...
    class SuccessfulTests {
        ...
        void registerUser() throws Exception {
            UserDetailResponse userDetailResponse = new UserDetailResponse(1L, 1L,"John", "john@example.com", "password", "john123");
        ...
        void updateUser() throws Exception {
            UserDetailResponse userDetailResponse = new UserDetailResponse(1L, 1L,"John Updated", "john@example.com", "newpassword", "john123updated" );
